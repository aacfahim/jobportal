 ...
 * @author fhoqu
 */
public class BanAccount extends javax.swing.JFrame {

    /**
     * Creates new form BanAccount
     */
    Connection conn;
    ResultSet rs;
    ResultSet rs1;
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(705, 629));
    ...
    public void search()
    {
        ...
        String sql = "select * from jobprovider where email = '" +str+"'";  //View
    ...
    public void ban()
    {
        ...
        String sql = "delete from jobprovider where email = '" +str+"'";
        String sql1 = "insert into BAN (EMAIL,COMPANY,C_USERNAME) values (?,?,?)";*/
        ...
        try
        {
            ...
            JOptionPane.showMessageDialog(null, "Account Banned");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BanAccount().setVisible(true);
            }
        });
    }
